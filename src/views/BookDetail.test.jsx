...
describe('BookDetail', () => {
  describe('When user is not logged in', () => {
    it('renders book detail with button of LogIn', () => {
      const tree = renderer.create(<TestRouter path="/books/1" />).toJSON();
  ...
  describe('When user is logged in', () => {
    ...
    it('renders book detail with button of LogOut', () => {
      const tree = renderer.create(<TestRouter path="/books/1" />).toJSON();
      expect(tree).toMatchSnapshot();
    });
  });
