...
export default function BookEdit(prop) {
  const {
    title, isbn, author, genre, description, imageUrl,
  } = prop.location.query;
                  ...
                  <Form className="box">
                    <div className="field">
                      <label htmlFor="Title" className="label">
                        ...
                        <div className="control has-icons-left">
                          <Field type="text" name="title" placeholder="Title" className="input" value={title} />
                    ...
                    <div className="field">
                      <label className="label" htmlFor="isbn">
                        ISBN
                        <div className="control has-icons-left">
                          <Field className="input" name="isbn" type="number" placeholder="9786124497001" value={isbn} />
                    ...
                    <div className="field">
                      <label className="label" htmlFor="author">
                        Author
                        <div className="control has-icons-left">
                          <Field className="input" name="author" type="text" placeholder="Bastian Hilcker" value={author} />
                    ...
                    <div className="field">
                      <label htmlFor="genre" className="label">
                        Genre
                        <div className="control has-icons-left">
                          <Field type="text" name="genre" className="input" placeholder="Fantasy" value={genre} />
                    ...
                    <div className="field">
                      <label htmlFor="description" className="label">
                        Description
                        <div className="control has-icons-left">
                          <Field type="text" name="description" className="textarea" placeholder="Noice" value={description} />
